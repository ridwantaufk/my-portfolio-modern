      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div
                className={`text-justify text-lg leading-relaxed space-y-4 ${
                  theme === "light"
                    ? "text-gray-700"
                    : theme === "dark"
                    ? "text-gray-300"
              ...
              >
                <p>
                  Hello! I'm{" "}
                  <strong className="text-blue-700">Ridwan Taufik</strong>, a
                  passionate Full Stack Developer with over 3 years of
                  experience in creating innovative web solutions. I specialize
                  in modern JavaScript technologies and love turning complex
                  problems into simple, beautiful designs.
                </p>
                <p>
                  My journey in web development started with a curiosity about
                  how websites work, and it has evolved into a career where I
                  get to build amazing digital experiences every day. I'm
